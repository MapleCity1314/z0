...
export const defaultMetadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon.ico" },
      { url: "/brand/icons/web/android-chrome-192x192.png", sizes: "192x192", type: "image/png" },
      { url: "/brand/icons/web/android-chrome-512x512.png", sizes: "512x512", type: "image/png" },
    ],
    apple: [
      { url: "/brand/icons/web/apple-touch-icon.png", sizes: "180x180", type: "image/png" },
    ],
  },
  openGraph: {
    type: "website",
